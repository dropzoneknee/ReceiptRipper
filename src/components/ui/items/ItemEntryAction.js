...
export default function ItemEntryAction(props) {
  return (
    <div className="overflow-hidden w-full flex flex-col">
      <div className="flex h-14 text-center justify-center text-white">
      ...
      <div className="grow">
        <div className="h-1.5/10"></div>
        <div className="h-5/10">
          <div>
            <div className="overflow-x-scroll flex items-center py-4">
              <div
                className={
                      ...
                      <div className="text-sm flex">
                        ...
                        {data.active ? (
                          <h1 className="opacity-30">
                            &#40;+$
                            {(props.itemCost / props.splitItems.length).toFixed(
                              2
                            )}
                            &#41;
                          </h1>
